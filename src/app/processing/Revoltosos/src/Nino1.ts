...
export default class Nino1 extends Nino {
	...
	constructor(log: Logica, x: number, y: number, ancho: number, alto: number) {
		...
		this.nino = this.img.loadImage("/img/2019/revoltosos/data/boy_feliz.png");
		this.ninopide = this.img.loadImage("/img/2019/revoltosos/data/boy_pidiendo.png");
		...
		this.ninopanal = this.img.loadImage("/img/2019/revoltosos/data/boy_popis.png");
		this.ninopanitos = this.img.loadImage("/img/2019/revoltosos/data/boy_panitos.png");
		this.ninolimpio = this.img.loadImage("/img/2019/revoltosos/data/boy_limpio.png");
