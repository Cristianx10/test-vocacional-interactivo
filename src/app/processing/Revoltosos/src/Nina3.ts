...
export default class Nina3 extends Nino {
	...
	constructor(log: Logica, x: number, y: number, ancho: number, alto: number) {
		...
		this.nino = this.img.loadImage("/img/2019/revoltosos/data/girl_morena_feliz.png");
		this.ninopide = this.img.loadImage("/img/2019/revoltosos/data/girl_morena_pidiendo.png");
		...
		this.ninopanal = this.img.loadImage("/img/2019/revoltosos/data/girl_morenita_popis.png");
		this.ninopanitos = this.img.loadImage("/img/2019/revoltosos/data/girl_morenita_panitos.png");
		this.ninolimpio = this.img.loadImage("/img/2019/revoltosos/data/girl_morenita_limpia.png");
	}
